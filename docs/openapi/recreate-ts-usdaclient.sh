...
openapi-generator generate -i ${DIR}/fdcnal-food-data_central_api-1.0.0-swagger.json -g typescript-axios -o ${DIR}/../../fev2/macromacro/src/usda --api-package usdaclient --model-package usdamodel
